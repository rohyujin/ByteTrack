...
class MOTEvaluatorCustom:
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                ...
                if video_name == 'MOT17-01-FRCNN':
                    ...
                    self.args.track_thresh = 0.3  # ori_thresh
            ...
            output_results = self.convert_to_coco_format(outputs, info_imgs, ids, face_eye_detector)  # Output 확인 필요
    ...
    def convert_to_coco_format(self, outputs, info_imgs, ids, face_eye_detector=None):  # Output 확인 필요
        data_list = []

        face_detector = None
        eye_detector = None

        if face_eye_detector is not None:
            face_detector, eye_detector = face_eye_detector["face_detector"], face_eye_detector["eye_detector"]
